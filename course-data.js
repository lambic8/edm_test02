// EDM学習コース - 基本データ定義（Avicii風対応版・18ステップ対応）
window.EDMCourseData = {
    name: "EDM制作コース - Avicii風感動的楽曲制作",
    description: "美しいピアノから壮大なドロップまでのAvicii風音楽的旅路を18ステップで体験",
    totalSteps: 18,
    ...
    learningTips: {
        ...
        18: "🎊 Avicii風楽曲の完成：美しいピアノアルペジオから始まり、感動的なドロップを経て、静寂な美しさで終わる完璧なAvicii風楽曲が完成しました！ピアノ、ストリングス、プラックシンセ、そしてパーカッションが織りなすサウンドは、まさに「Levels」「Wake Me Up」「Waiting for Love」といったAviciiの名曲と同じDNAを持っています。あなたは今、世界中で愛される音楽の作り方をマスターしました！"
    },
    ...
    successMessages: {
        ...
        18: "🎊 Avicii風楽曲完成！ 世界中で愛される音楽の作り方をマスターしました！"
    },
